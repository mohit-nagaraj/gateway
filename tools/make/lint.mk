...
.PHONY: lint
lint: ## Run all linter of code sources, including golint, prettier, whitenoise lint and codespell.
...
lint.prettier:
	@$(LOG_TARGET)
	$(GO_TOOL) prettier --check $$(git ls-files :*.yml :*.yaml)

.PHONY: format.prettier
format.prettier: ## Format YAML files with prettier
	@$(LOG_TARGET)
	$(GO_TOOL) prettier --write $$(git ls-files :*.yml :*.yaml)
